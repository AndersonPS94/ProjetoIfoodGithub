package com.example.projetoifoodgithub.pedido
...
class ConfirmacaoPedidoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.txtResumo.text = """Resumo dos valores Subtotal: R$ 100,00 Taxa de entrega: R$ 6,90 Total: R$ 106,90""".trimIndent()
